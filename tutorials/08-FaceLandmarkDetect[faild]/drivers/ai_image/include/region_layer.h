...
typedef void (*callback_draw_box)(uint32_t x1, uint32_t y1, uint32_t x2,
                                  ...
                                  uint32_t *landmark, uint32_t landm_num);
...
int region_layer_init(region_layer_t *rl, const float *anchor,
                      uint32_t anchor_num, uint32_t crood_num,
                      uint32_t landm_num, uint32_t cls_num, uint32_t in_w,
                      uint32_t in_h, float obj_thresh, float nms_thresh,
                      float *variances);
